...
[!code-csharp[Program.cs](examples/ApiQuirks/Program.cs#CommercialUse)]
...
[!code-csharp[Program.cs](examples/ApiQuirks/Program.cs#TimeoutConfiguration)]
...
[!code-csharp[Program.cs](examples/ApiQuirks/Program.cs#SortValues)]
...
[!code-csharp[Program.cs](examples/ApiQuirks/Program.cs#FilterComposition)]

### Error Handling

Always handle potential errors, especially for the creators endpoint:

[!code-csharp[Program.cs](examples/ApiQuirks/Program.cs#ErrorHandling)]
